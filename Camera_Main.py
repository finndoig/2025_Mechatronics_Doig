...
InSight = False # boolean to track if character is currently in sight
...
while(Character_Count > 0):
    ...
    char_arr = np.asarray(Character1)
    ...
    if lower is not None and upper is not None:
        ...
        if np.any(mask):
            ...
            InSight = True #Character is in sight
            print("Character sighted!")
    ...
    if InSight == True and np.any(mask) == False:
        LostSightTimer += 1
